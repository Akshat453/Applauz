  ...
  return (
    <label className={`block space-y-2 ${className}`} htmlFor={id}>
      ...
      <input
        ...
        className="h-12 w-full rounded-sm border border-line bg-white px-4 text-base text-ink outline-none transition placeholder:text-ink/35 focus:border-primary focus:ring-2 focus:ring-primary/20"
        {...props}
      />
