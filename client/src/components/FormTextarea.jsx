  ...
  return (
    <label className={`block space-y-2 ${className}`} htmlFor={id}>
      ...
      <textarea
        ...
        className="min-h-40 w-full rounded-sm border border-line/80 bg-white px-4 py-4 text-sm leading-6 text-ink outline-none transition placeholder:text-ink/35 focus:border-primary focus:ring-4 focus:ring-primary/10"
        {...props}
      />
